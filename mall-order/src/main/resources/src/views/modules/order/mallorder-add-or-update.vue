    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/order/mallorder/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.memberId = data.mallOrder.memberId
                this.dataForm.orderSn = data.mallOrder.orderSn
                this.dataForm.couponId = data.mallOrder.couponId
                this.dataForm.createTime = data.mallOrder.createTime
                this.dataForm.memberUsername = data.mallOrder.memberUsername
                this.dataForm.totalAmount = data.mallOrder.totalAmount
                this.dataForm.payAmount = data.mallOrder.payAmount
                this.dataForm.freightAmount = data.mallOrder.freightAmount
                this.dataForm.promotionAmount = data.mallOrder.promotionAmount
                this.dataForm.integrationAmount = data.mallOrder.integrationAmount
                this.dataForm.couponAmount = data.mallOrder.couponAmount
                this.dataForm.discountAmount = data.mallOrder.discountAmount
                this.dataForm.payType = data.mallOrder.payType
                this.dataForm.sourceType = data.mallOrder.sourceType
                this.dataForm.status = data.mallOrder.status
                this.dataForm.deliveryCompany = data.mallOrder.deliveryCompany
                this.dataForm.deliverySn = data.mallOrder.deliverySn
                this.dataForm.autoConfirmDay = data.mallOrder.autoConfirmDay
                this.dataForm.integration = data.mallOrder.integration
                this.dataForm.growth = data.mallOrder.growth
                this.dataForm.billType = data.mallOrder.billType
                this.dataForm.billHeader = data.mallOrder.billHeader
                this.dataForm.billContent = data.mallOrder.billContent
                this.dataForm.billReceiverPhone = data.mallOrder.billReceiverPhone
                this.dataForm.billReceiverEmail = data.mallOrder.billReceiverEmail
                this.dataForm.receiverName = data.mallOrder.receiverName
                this.dataForm.receiverPhone = data.mallOrder.receiverPhone
                this.dataForm.receiverPostCode = data.mallOrder.receiverPostCode
                this.dataForm.receiverProvince = data.mallOrder.receiverProvince
                this.dataForm.receiverCity = data.mallOrder.receiverCity
                this.dataForm.receiverRegion = data.mallOrder.receiverRegion
                this.dataForm.receiverDetailAddress = data.mallOrder.receiverDetailAddress
                this.dataForm.note = data.mallOrder.note
                this.dataForm.confirmStatus = data.mallOrder.confirmStatus
                this.dataForm.deleteStatus = data.mallOrder.deleteStatus
                this.dataForm.useIntegration = data.mallOrder.useIntegration
                this.dataForm.paymentTime = data.mallOrder.paymentTime
                this.dataForm.deliveryTime = data.mallOrder.deliveryTime
                this.dataForm.receiveTime = data.mallOrder.receiveTime
                this.dataForm.commentTime = data.mallOrder.commentTime
                this.dataForm.modifyTime = data.mallOrder.modifyTime
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/order/mallorder/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
