<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dataForm"
      ...
      <!-- <el-form-item label="删除标记(0:正常;1:删除)" prop="deleteFlag">
      <el-input v-model="dataForm.deleteFlag" placeholder="删除标记(0:正常;1:删除)"></el-input>
    </el-form-item> -->
    </el-form>
    <span slot="footer"
          class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    getCategorys () {
      this.$http({
        url: this.$http.adornUrl("/product/pmsattrgroup/list/tree"),
        method: "get"
      }).then(({ data }) => {
        ...
        if (this.dataForm.attrGroupId) {
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.dataForm.deleteFlag = data.attrGroup.deleteFlag
            }
          })
        }
      })
