        ...
        <el-card class="box-card">
          ...
          <div style="margin:auto">
            <el-button type="success"
                       style="float:right"
                       @click="submitSpuAttrs">确认修改</el-button>
          </div>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    getSpuBaseAttrs () {
      this.$http({
        url: this.$http.adornUrl(`/product/pmsattr/base/listforspu/${this.spuId}`),
        method: "get"
      }).then(({ data }) => {
    ...
    showBaseAttrs () {
      ...
      this.$http({
        url: this.$http.adornUrl(
          `/product/pmsattrgroup/${this.catalogId}/withattr`
        ),
        method: "get",
    ...
    submitSpuAttrs () {
      ...
      this.$confirm("修改商品规格信息, 是否继续?", "提示", {
        ...
        .then(() => {
          this.$http({
            url: this.$http.adornUrl(`/product/pmsattr/update/${this.spuId}`),
            method: "post",
