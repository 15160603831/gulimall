package com.hwj.mall.cart.Interceptor;


import com.hwj.common.constant.AuthConstant;
import com.hwj.common.vo.MemberEntity;
import com.hwj.mall.cart.constant.CartConstant;
...
public class CartInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        MemberEntity memberResponseVo = (MemberEntity) session.getAttribute(AuthConstant.LOGIN_USER);
