...
public class PmsAttrGroupServiceImpl extends ServiceImpl<PmsAttrGroupDao, PmsAttrGroupEntity> implements PmsAttrGroupService {
    ...
    @Override
    public List<SpuItemAttrGroupVo> getAtrGroupWithAttrsBySpuId(Long spuId, Long catalogId) {
        //查出单前所有属性的分组信息以及所有属性对应的值
        PmsAttrGroupDao baseMapper = this.getBaseMapper();
        List<SpuItemAttrGroupVo> a = baseMapper.getAtrGroupWithAttrsBySpuId(spuId, catalogId);
        return a;
    }
